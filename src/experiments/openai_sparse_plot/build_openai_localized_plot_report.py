...
DEFAULT_QUOTE_JSON = Path("results/quote/raw_delta_plot_quote_r6_v2/raw_delta_plot_abstraction.json")
DEFAULT_BRACKET_JSON = Path("results/bracket/fresh_raw_delta_bracket_fullscan_top12_r6/raw_delta_plot_abstraction.json")
DEFAULT_BRACKET_FULL_SCAN_JSON = Path("results/bracket/fresh_raw_delta_bracket_full_scan/bracket_raw_delta_scan.json")
DEFAULT_BRACKET_ROBUST_JSON = Path(
    "results/bracket/bracket_refined_causal_diagnostic_r12_lambda4_records/bracket_refined_causal_diagnostic.json"
)
DEFAULT_OUT_DIR = Path("results/combined/localized_plot_report")

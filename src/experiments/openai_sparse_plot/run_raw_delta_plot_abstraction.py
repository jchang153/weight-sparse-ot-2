...
DEFAULT_QUOTE_HARD_JSON = Path(
    "results/quote/unmatched_quote_abstraction_csp_yolo1_template/unmatched_quote_abstraction.json"
)
DEFAULT_QUOTE_NODE_CSV = Path("results/quote/string_closing_prune_v2_64/string_closing_circuit_nodes.csv")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("results/combined/raw_delta_plot"))
    ...
    parser.add_argument(
        "--bracket-node-csv",
        type=Path,
        default=Path("results/bracket/bracket_counting_inventory_csp_yolo2_prune_v4/string_closing_circuit_nodes.csv"),
    )

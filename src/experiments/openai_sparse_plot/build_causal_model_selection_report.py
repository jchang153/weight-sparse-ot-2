...
DEFAULT_QUOTE_ROOT = Path("results/quote")
DEFAULT_BRACKET_JSON = Path(
    "results/bracket/causal_model_selection_20260629/bracket_multidepth/bracket_multidepth_model_selection.json"
)
DEFAULT_OUT_DIR = Path("results/combined/causal_model_selection_20260629/report")

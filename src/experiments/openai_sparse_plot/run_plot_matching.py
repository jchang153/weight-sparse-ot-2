...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--table-json",
        type=Path,
        default=Path("results/quote/effect_signatures/effect_signature_table.json"),
    )
    parser.add_argument("--out-dir", type=Path, default=Path("results/quote/plot_matching"))

...
| `raw_squared_uot` | 9 | `7.mlp.resid_delta:431` | 0.000 | 26.368 | n/a |
| `raw_squared_uot` | 10 | `7.mlp.post_act:7058` | 0.000 | 29.727 | n/a |
| `raw_squared_uot` | 11 | `7.mlp.resid_delta:607` | 0.000 | 31.276 | n/a |
| `raw_squared_uot` | 12 | `2.mlp.act_in:1249` | 0.000 | 32.191 | n/a |
...
| `raw_cosine_uot` | 9 | `7.mlp.resid_delta:607` | 0.046 | 0.014 | 0.986 |
| `raw_cosine_uot` | 10 | `4.attn.act_in:1249` | 0.044 | 0.020 | 0.980 |
| `raw_cosine_uot` | 11 | `7.mlp.post_act:2511` | 0.041 | 0.032 | 0.968 |
| `raw_cosine_uot` | 12 | `7.mlp.post_act:3082` | 0.041 | 0.032 | 0.968 |
...
| `raw_cosine_similarity` | 9 | `7.mlp.resid_delta:607` | 0.029 | 0.014 | 0.986 |
| `raw_cosine_similarity` | 10 | `4.attn.act_in:1249` | 0.029 | 0.020 | 0.980 |
| `raw_cosine_similarity` | 11 | `7.mlp.post_act:2511` | 0.029 | 0.032 | 0.968 |
| `raw_cosine_similarity` | 12 | `7.mlp.post_act:3082` | 0.029 | 0.032 | 0.968 |

...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--graph-json",
        type=Path,
        default=Path("eval/openai_sparse_plot/string_closing_prune_v2_64/string_closing_circuit.json"),
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("eval/openai_sparse_plot/string_closing_interpreted"),
    )

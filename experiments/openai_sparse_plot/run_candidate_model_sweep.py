...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--base-table-json",
        type=Path,
        default=Path("eval/openai_sparse_plot/effect_signatures_simple_chain_csp_yolo1_pairs8/effect_signature_table.json"),
    )
    parser.add_argument("--out-dir", type=Path, default=Path("eval/openai_sparse_plot/candidate_model_sweep"))
